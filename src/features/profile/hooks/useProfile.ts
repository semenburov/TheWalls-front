...
import userService from '@features/auth/services/user.service' // Сервіс для роботи з користувачами (отримання профілю)
...
export function useProfile() {
	...
	const { data, isLoading, error } = useQuery({
		...
		queryFn: () => userService.fetchProfile(), // Функція-запит до API
